...
const CreateForm = ({setModalOpen, setRefresh}) => {
  const initialValues = {
    title: "",
    description: "",
    dueDate: "",
  ...
  const validationSchema = Yup.object({
    ...
    description: Yup.string().max(300, "Description can't be more than 300 characters long"),
        ...
        >
          {({ resetForm, handleChange, values }) => (
            <Form>
              ...
              {error && <div className={`${styles.error} ${nunito.className}`}>{error}</div>}
